  ...
  return (
     <div className="container">
        <header>
            ...
            <p className="subtitle"><span className="status-indicator"></span>Real-Time Monitoring</p>
            <div className="timestamp">⏱ 2025-12-26T20:22:30.647Z</div>
        </header>
        ...
        <div className="grid">
            ...
            <div className="card section-wide">
                ...
                <h3 style= {{marginTop: "25px", marginBottom: "15px", color: "#00f0ff", fontFamily: 'Orbitron sansSerif', fontSize: "1rem"}}>Network Adapters</h3>
            ...
            <div className="card section-wide">
                ...
                <p style={{color: "#8b95a8", marginBottom: "15px", fontSize: "0.85rem"}}>
                    Monitoring <span style={{color: "#00f0ff", fontWeight: 600}}>68 active ports</span> on the system
                </p>
                
                <div className="ports-grid">
                    <div className="port-item">
                        <span className="port-proto">UDP</span> 0.0.0.0:53<br />
                        <span className="port-state">BOUND · PID 3576</span>
                    </div>
                    <div className="port-item">
                        <span className="port-proto">TCP</span> 0.0.0.0:135<br />
                        <span className="port-state">LISTENING · PID 640</span>
                    </div>
                    <div className="port-item">
                        <span className="port-proto">TCP</span> [::]:135<br />
                        <span className="port-state">LISTENING · PID 640</span>
                    </div>
                    <div className="port-item">
                        <span className="port-proto">TCP</span> 0.0.0.0:445<br />
                        <span className="port-state">LISTENING · PID 4</span>
                    </div>
                    <div className="port-item">
                        <span className="port-proto">TCP</span> 0.0.0.0:3000<br />
                        <span className="port-state">LISTENING · PID 9408</span>
                    </div>
                    <div className="port-item">
                        <span className="port-proto">TCP</span> [::]:3000<br />
                        <span className="port-state">LISTENING · PID 9408</span>
                    </div>
                    <div className="port-item">
                        <span className="port-proto">UDP</span> 0.0.0.0:5353<br />
                        <span className="port-state">BOUND · PID 3192</span>
                    </div>
                    <div className="port-item">
                        <span className="port-proto">TCP</span> 127.0.0.1:8828<br />
                        <span className="port-state">LISTENING · PID 10016</span>
                    </div>
                    <div className="port-item">
                        <span className="port-proto">TCP</span> 127.0.0.1:50001<br />
                        <span className="port-state">LISTENING · PID 5992</span>
                    </div>
                    <div className="port-item">
                        <span className="port-proto">UDP</span> 192.168.199.87:137<br />
                        <span className="port-state">BOUND · PID 4</span>
                    </div>
                    <div className="port-item">
                        <span className="port-proto">TCP</span> 192.168.199.87:139<br />
                        <span className="port-state">LISTENING · PID 4</span>
                    </div>
                    <div className="port-item">
                        <span className="port-proto">UDP</span> 0.0.0.0:1900<br />
                        <span className="port-state">BOUND · PID 5264</span>
                    </div>
                    <div className="port-item">
                        <span className="port-proto">TCP</span> 0.0.0.0:5040<br />
                        <span className="port-state">LISTENING · PID 7272</span>
                    </div>
                    <div className="port-item">
                        <span className="port-proto">UDP</span> 0.0.0.0:5355<br />
                        <span className="port-state">BOUND · PID 3192</span>
                    </div>
                    <div className="port-item">
                        <span className="port-proto">TCP</span> 0.0.0.0:5357<br />
                        <span className="port-state">LISTENING · PID 4</span>
                    </div>
                    <div className="port-item">
                        <span className="port-proto">TCP</span> 0.0.0.0:49664<br />
                        <span className="port-state">LISTENING · PID 688</span>
                    </div>
                </div>
                
                <p style={{color: "#8b95a8", marginTop: "20px", fontSize:" 0.75rem", textAlign: "center"}}>
